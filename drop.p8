...
function cust_draw()
	roundrect(34,14,59,48,6,0)
	roundrect(38,18,51,10,6,2)
	local st="select ship"
	lprint(st,hcenter(st),20,7,4)
	spr(16,30+sel*10,38+sin(time()))
	for i = 1,#p_spr_opt do
		spr(p_spr_opt[i],30+i*10,48)
	end
	local et = "press 🅾️ to exit"
	print(et,hcenter(et),68,6)
end
...

